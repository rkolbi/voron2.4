...
**NOTE:** These configurations utilize the Euclid probe, Gantry Mounted (GM) docking. The dock is mounted on the gantry by the stepper motor, no longer requires the Z-axis endstop switch, as it uses the Euclid probe to find Z home.  
